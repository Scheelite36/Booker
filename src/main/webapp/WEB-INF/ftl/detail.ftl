...
<div class="container ">
    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
        ...
        <div class="row" style="background-color: rgba(0,0,0,0.1);">
            <div class="col-2"><h2 class="text-white">${book.score}</h2></div>
            <div class="col-5 pt-2">
                <span class="stars" data-score="${book.score}"></span>
            </div>
            <div class="col-5  pt-2"><h5 class="text-white">${book.quantity}人已评</h5></div>
        </div>
    </div>
    ...
    <div class="reply pl-2 pr-2">
        <#list evaluationList as evaluations>
            <div>
            <div>
                <span class="pt-1 small text-black-50 mr-2">${evaluations.createTime?string('MM-dd')}</span>
